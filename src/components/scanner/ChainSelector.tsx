  ...
  return (
    <div>
      ...
      <select
        ...
        className="w-full bg-surface-highest border border-outline text-sm text-on-surface px-4 py-3 focus:border-accent transition-all duration-300 outline-none appearance-none cursor-pointer hover:border-accent/30"
      >
